<template>
  <div>
    <button class="block w-14 h-14 border-2 border-gray-300 rounded-full overflow-hidden">
      <img
    ...
    <div class="w-48 mt-1 py-3 flex flex-col bg-white  rounded-lg">
      <a class="transition-colors duration-300 px-4 py-1 text-gray-800 hover:bg-indigo-600 hover:text-white" href="#">Account setting</a>
